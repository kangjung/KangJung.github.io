...
Before starting the game, I put common instructions into a personal Unity base repository. New projects can inherit the workflow and build their own design notes and decisions on top.
